...
import {
  any
} from "./_node-chunks/chunk-NAWTBYUG.js";
import {
  require_dist
...
import {
  ...
  require_re,
  require_semver
} from "./_node-chunks/chunk-WPYSC2GJ.js";
import {
  __commonJS,
  __toESM
...
var require_range = __commonJS({
  "../../../node_modules/semver/classes/range.js"(exports, module) {
    ...
    var LRU = require_lrucache(), cache = new LRU(), parseOptions = require_parse_options(), Comparator = require_comparator(), debug = require_debug(), SemVer = require_semver(), {
      ...
      tildeTrimReplace,
      caretTrimReplace
    } = require_re(), { FLAG_INCLUDE_PRERELEASE, FLAG_LOOSE } = require_constants(), BUILDSTRIPRE = new RegExp(src[t2.BUILD], "g"), isNullSet = (c) => c.value === "<0.0.0-0", isAny = (c) => c.value === "", isSatisfiable = (comparators, options) => {
      ...
      let r = options.loose ? re[t2.TILDELOOSE] : re[t2.TILDE], z = options.includePrerelease ? "-0" : "";
...
async function getTemplatePath(name) {
  switch (name) {
    case "vitest.config.template":
      return import("./_node-chunks/vitest.config.template-7WDRR2VA.js");
    case "vitest.config.4.template":
      return import("./_node-chunks/vitest.config.4.template-4ST5CPM2.js");
    case "vitest.config.3.2.template":
      return import("./_node-chunks/vitest.config.3.2.template-3R6HXUAI.js");
    case "vitest.workspace.template":
      return import("./_node-chunks/vitest.workspace.template-CN4HVAEJ.js");
    default:
