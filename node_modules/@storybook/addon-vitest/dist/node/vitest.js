...
import "../_node-chunks/chunk-R62V2LJK.js";
import {
  dirname,
  join,
  normalize,
...
import "../_node-chunks/chunk-INJUEWZI.js";
...
function formatError(error) {
  ...
  let message = (error.message ?? "").replace(DEBUG_BANNER_RE, ""), frames = error.stacks.map(
    ({ method, file, line, column }) => `    at ${method || "<anonymous>"} (${file}:${line}:${column})`
  );
