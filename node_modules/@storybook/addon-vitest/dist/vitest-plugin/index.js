...
var require_parse = __commonJS({
  "../../../node_modules/braces/lib/parse.js"(exports, module) {
    ...
    var stringify = require_stringify(), {
      ...
      CHAR_NO_BREAK_SPACE,
      CHAR_ZERO_WIDTH_NOBREAK_SPACE
    } = require_constants(), parse3 = (input, options = {}) => {
...
var require_braces = __commonJS({
  "../../../node_modules/braces/index.js"(exports, module) {
    "use strict";
    var stringify = require_stringify(), compile = require_compile(), expand = require_expand(), parse3 = require_parse(), braces = (input, options = {}) => {
      let output = [];
...
var require_parse2 = __commonJS({
  "../../../node_modules/picomatch/lib/parse.js"(exports, module) {
    ...
    var constants = require_constants2(), utils = require_utils2(), {
      ...
      return value;
    }, syntaxError = (type, char) => `Missing ${type}: "${char}" - use "\\\\${char}" to match literal characters`, parse3 = (input, options) => {
      if (typeof input != "string")
        throw new TypeError("Expected a string");
      ...
      let extglobs = [], braces = [], stack = [], prev = bos, value, eos = () => state.index === len - 1, peek = state.peek = (n = 1) => input[state.index + n], advance = state.advance = () => input[++state.index] || "", remaining = () => input.slice(state.index + 1), consume = (value2 = "", num = 0) => {
        ...
        if (token.type === "negate") {
          ...
          if (token.inner && token.inner.length > 1 && token.inner.includes("/") && (extglobStar = globstar(opts)), (extglobStar !== star || eos() || /^\)+$/.test(remaining())) && (output = token.close = `)$))${extglobStar}`), token.inner.includes("*") && (rest = remaining()) && /^\.[^\\/.]+$/.test(rest)) {
            let expression = parse3(rest, { ...options, fastpaths: !1 }).output;
...
var require_picomatch = __commonJS({
  "../../../node_modules/picomatch/lib/picomatch.js"(exports, module) {
    "use strict";
    var path2 = __require("path"), scan = require_scan(), parse3 = require_parse2(), utils = require_utils2(), constants = require_constants2(), isObject = (val) => val && typeof val == "object" && !Array.isArray(val), picomatch = (glob, options, returnState = !1) => {
    ...
    picomatch.parse = (pattern, options) => Array.isArray(pattern) ? pattern.map((p) => picomatch.parse(p, options)) : parse3(pattern, { ...options, fastpaths: !1 });
    ...
    picomatch.makeRe = (input, options = {}, returnOutput = !1, returnState = !1) => {
      ...
      return options.fastpaths !== !1 && (input[0] === "." || input[0] === "*") && (parsed.output = parse3.fastpaths(input, options)), parsed.output || (parsed = parse3(input, options)), picomatch.compileRe(parsed, options, returnOutput, returnState);
    };
...
var require_build = __commonJS({
  "../../../node_modules/sirv/build.js"(exports, module) {
    var fs = __require("fs"), { join: join2, normalize: normalize2, resolve: resolve3 } = __require("path"), { totalist } = require_sync(), { parse: parse3 } = (init_build(), __toCommonJS(build_exports)), { lookup } = require_mrmime(), noop = () => {
    };
...
var import_picocolors = __toESM(require_picocolors(), 1), import_sirv = __toESM(require_build(), 1), import_ts_dedent2 = __toESM(require_dist(), 1);
...
// src/vitest-plugin/stack-frames.ts
var INTERNAL_FRAME_PATTERNS = [
  /[\\/]storybook[\\/]dist[\\/]/,
  /[\\/]@storybook[\\/][^\\/]+[\\/]dist[\\/]/,
  /[\\/]deps[\\/]@?storybook[@_]/
];
function isStorybookInternalFrame(file) {
...
var WORKING_DIR = process.cwd(), defaultOptions = {
  ...
  let agent, withinAgenticSetupSession = !1, storybookTestPlugin = {
    ...
    async config(nonMutableInputConfig, { mode }) {
      ...
      finalOptions.vitestRoot = testConfig?.dir || testConfig?.root || viteConfigFromStorybook.root || nonMutableInputConfig.root || process.cwd();
      ...
      let projectId = oneWayHash(finalOptions.configDir), internalSetupFiles = [
        ...
        test: {
          ...
          onStackTrace: (error, frame) => isStorybookInternalFrame(frame.file) ? !1 : nonMutableInputConfig.test?.onStackTrace?.(error, frame) ?? !0,
          setupFiles: [
            ...internalSetupFiles,
