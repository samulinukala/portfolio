...
function __asyncDelegator(o) {
  ...
  function verb(n2, f3) {
    i2[n2] = o[n2] ? function(v2) {
      return (p2 = !p2) ? { value: __await(o[n2](v2)), done: false } : f3 ? f3(v2) : v2;
    } : f3;
  }
}
...
function __importStar(mod2) {
  ...
  var result = {};
  if (mod2 != null) {
    for (var k2 = ownKeys(mod2), i2 = 0; i2 < k2.length; i2++) if (k2[i2] !== "default") __createBinding(result, mod2, k2[i2]);
  }
...
function createDate(y, m2, d2, h2, M2, s, ms) {
  var date;
  if (y < 100 && y >= 0) {
    date = new Date(y + 400, m2, d2, h2, M2, s, ms);
    if (isFinite(date.getFullYear())) {
      date.setFullYear(y);
    }
  } else {
    date = new Date(y, m2, d2, h2, M2, s, ms);
  }
  return date;
}
...
function sha1(bytes) {
  ...
  for (let i2 = 0; i2 < N2; ++i2) {
    ...
    for (let t2 = 0; t2 < 80; ++t2) {
      ...
      const T2 = ROTL(a2, 5) + f(s, b2, c2, d2) + e + K2[s] + W2[t2] >>> 0;
      e = d2;
      d2 = c2;
      c2 = ROTL(b2, 30) >>> 0;
      b2 = a2;
...
function ruleset(value, root, parent, index, offset2, rules, points, type, props, children, length2, siblings) {
  ...
  for (var i2 = 0, j2 = 0, k2 = 0; i2 < index; ++i2)
    for (var x2 = 0, y = substr(value, post + 1, post = abs2(j2 = points[i2])), z2 = value; x2 < size; ++x2)
...
function prefix(value, length2, children) {
  switch (hash(value, length2)) {
    ...
    case 5152:
    case 5920:
      return replace(value, /(.+?):(\d+)(\s*\/\s*(span)?\s*(\d+))?(.*)/, function(_2, a2, b2, c2, d2, e, f3) {
        return MS + a2 + ":" + b2 + f3 + (c2 ? MS + a2 + "-span:" + (d2 ? e : +e - +b2) + f3 : "") + value;
      });
    // position: sticky
    case 4949:
...
var f2 = Boolean("boolean" == typeof SC_DISABLE_SPEEDY ? SC_DISABLE_SPEEDY : null !== (i = null !== (r = p("REACT_APP_SC_DISABLE_SPEEDY")) && void 0 !== r ? r : p("SC_DISABLE_SPEEDY")) && void 0 !== i ? i : "undefined" == typeof process || void 0 === process.env || true);
var m = "sc-keyframes-";
...
`, s = console.error;
    try {
      ...
      }, "function" == typeof import_react5.default.useState && import_react5.default.useState(null), e2 && !P.has(o) && (console.warn(o), P.add(o));
    } catch (e2) {
...
var Ee = d;
var Ae = { isServer: !d, useCSSOMInjection: !f2 };
var Pe = class _Pe {
  static registerId(e) {
    return C(e);
  }
...
var Je = new Pe();
var Xe = Ue();
var Ke = import_react5.default.createContext({ shouldForwardProp: void 0, styleSheet: Je, stylis: Xe, stylisPlugins: void 0 });
var Qe = Ke.Consumer;
function Ze() {
  return import_react5.default.useContext(Ke);
}
var tt = import_react5.default.createContext(void 0);
var nt = tt.Consumer;
...
function lt(o, s, r2) {
  ...
  if (i2 && c2.shouldForwardProp) {
    ...
    if (s.shouldForwardProp) {
      ...
      f3 = (n2, o2) => e(n2, o2) && t2(n2, o2);
    } else f3 = e;
  }
  const m2 = new Le(r2, d2, i2 ? c2.componentStyle : void 0);
  function y(o2, s2) {
    return (function(o3, s3, r3) {
      const { attrs: i3, componentStyle: c3, defaultProps: a3, foldedComponentIds: l3, styledComponentId: u3, target: h3 } = o3, d3 = import_react5.default.useContext(tt), p3 = Ze(), f4 = o3.shouldForwardProp || p3.shouldForwardProp;
      import_react5.default.useDebugValue && import_react5.default.useDebugValue(u3);
      const m3 = R(s3, d3, a3) || $;
      let y2, g3;
      {
        const e = import_react5.default.useRef(null), n2 = e.current;
        if (null !== n2 && n2[1] === m3 && n2[2] === p3.styleSheet && n2[3] === p3.stylis && n2[7] === c3 && (function(e2, t2, n3) {
          ...
          y2 = (function(e2, t2, n4) {
            ...
            return import_react5.default.useDebugValue && import_react5.default.useDebugValue(r4), r4;
      ...
      let b2 = ce(l3, u3);
      return g3 && (b2 += " " + g3), y2.className && (b2 += " " + y2.className), S2[L(v2) && v2.includes("-") ? "class" : "className"] = b2, r3 && (S2.ref = r3), (0, import_react5.createElement)(v2, S2);
    })(g2, o2, s2);
  }
  y.displayName = h2;
  let g2 = import_react5.default.forwardRef(y);
  return g2.attrs = p2, g2.componentStyle = m2, g2.displayName = h2, g2.shouldForwardProp = f3, g2.foldedComponentIds = i2 ? ce(c2.foldedComponentIds, c2.styledComponentId) : "", g2.styledComponentId = d2, g2.target = i2 ? c2.target : o, Object.defineProperty(g2, "defaultProps", { get() {
...
`;
var VerifiedBadge2 = yt(verified_badge_default)`
    margin-left: 4px;
    flex-shrink: 0;
`;
...
var Background = yt.div`
    ...
    pointer-events: none;
`;
var Attribution2 = yt(attribution_default)`
    position: absolute;
    bottom: 10px;
    left: 10px;
    right: 10px;
`;
var Container3 = yt.div`
...
`;
var Observer2 = yt(observer_default)`
    display: inline-block;
`;
var Loader = yt.div`
    width: 30px;
...
`;
var VariationsViewport = yt.div`
    overflow-x: auto;
    overflow-y: hidden;
    position: relative;
    -webkit-overflow-scrolling: touch;
`;
var VariationsContainer = yt.div`
    display: inline-flex;
...
var Scanner = yt.div`
    ...
    filter: blur(1px);
`;
var SearchIcon2 = yt(search_icon_default)`
    z-index: 1;
    display: flex;
    width: 50%;
    height: 50%;
...
var Input = yt.input`
    ...
    min-width: 150px;
    flex: 1;
    ${(props) => props.$isUsernameSearch && pt`
            color: ${giphyIndigo};
        `}
`;
var SearchBar = ({
...
var margin = 9;
var ChannelPillContainer = yt.div`
    ...
    cursor: pointer;
`;
var TrendingSearchPillContainer = yt.div`
    background: ${giphyDarkestGrey};
    display: flex;
    padding: 14px;
    align-items: center;
    ...
    border-radius: 20px;
`;
var Avatar4 = yt(avatar_default)`
    height: var(${CssVars.searchbarHeight});
    width: var(${CssVars.searchbarHeight});
`;
var TrendingIcon2 = yt(trending_icon_default)`
    margin-right: 2px;
`;
...
var Container11 = yt.div`
    display: flex;
    align-items: center;
    font-family: interface, helvetica, arial;
    cursor: pointer;
`;
var Avatar5 = yt(avatar_default)`
    flex-shrink: 0;
`;
var Right = yt.div`
    display: flex;
...
var VideoContainer = yt.div`
    ...
    width: 100%;
`;
var VideoStyled = yt(video_default2)`
    height: 100%;
    display: inline-block;
    object-fit: fill;
    pointer-events: none;
...
function FetchingCommentsSkeletons() {
  ...
  return (0, import_jsx_runtime22.jsx)("div", { style: {
    ...
    paddingRight: 16,
    paddingLeft: 16
  }, children: [1, 2, 3].map((i2) => (0, import_jsx_runtime22.jsx)(CommentSkeleton, {}, i2)) });
}
