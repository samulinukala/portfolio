...
//#endregion
//#region src/utils/ReferenceMap.d.ts
/**
* Schema reference map with collision-free reference ID allocation.
*/
declare class ReferenceMap extends Map<BaseSchema<unknown, unknown, BaseIssue<unknown>>, string> {
  /**
  ...
  */
  set(schema: BaseSchema<unknown, unknown, BaseIssue<unknown>>, referenceId: string): this;
  /**
