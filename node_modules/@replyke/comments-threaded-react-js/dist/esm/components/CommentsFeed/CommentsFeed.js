...
const CommentsFeed = React.memo(({ children: customNoCommentsView }) => {
    ...
    const mergedComments = useMemo(() => {
        ...
        if (highlightedComment) {
            ...
            combinedComments = combinedComments.filter((item) => item.id !== comment.id && item.id !== parentComment?.id);
        }
    ...
    return (_jsxs("div", { style: { flex: 1 }, children: [showLoadedComments && _jsx(LoadedComments, { data: mergedComments }), showFetchingSkeletons && _jsx(FetchingCommentsSkeletons, {}), showNoComments && (customNoCommentsView ?? _jsx(NoCommentsPlaceHolder, {}))] }));
});
export default CommentsFeed;
//# sourceMappingURL=CommentsFeed.js.map