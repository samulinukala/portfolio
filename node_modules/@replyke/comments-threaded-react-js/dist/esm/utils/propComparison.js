 ...
 */
export function warnPropChanges(componentName, prevProps, nextProps, propNames) {
    if (!isDevelopment()) {
        return;
    }
    for (const propName of propNames) {
        ...
        if (prevValue !== nextValue && !deepEqual(prevValue, nextValue)) {
            console.warn(`[${componentName}] Prop '${propName}' changed but has the same content. ` +
                `Consider memoizing this prop to prevent unnecessary re-renders.`, { prevValue, nextValue });
        }
    }
}
//# sourceMappingURL=propComparison.js.map