...
exports.deleteEntity = exports.updateEntity = exports.createEntity = exports.fetchEntities = exports.useDeleteEntityMutation = exports.useUpdateEntityMutation = exports.useCreateEntityMutation = exports.useLazyFetchEntitiesQuery = exports.useFetchEntitiesQuery = exports.entityListsApi = void 0;
...
var serializeObject = function (obj, prefix) {
    ...
    var _loop_1 = function (key) {
        if (obj.hasOwnProperty(key)) {
            var value = obj[key];
            var paramKey_1 = prefix ? "".concat(prefix, "[").concat(key, "]") : key;
                ...
                value.forEach(function (item, index) {
                    if (item !== null && item !== undefined) {
                        if (typeof item === 'object') {
                            Object.assign(params, serializeObject(item, "".concat(paramKey_1, "[").concat(index, "]")));
                        }
                        else {
                            params["".concat(paramKey_1, "[").concat(index, "]")] = item;
                        }
                    }
                });
            }
            else if (typeof value === 'object') {
                Object.assign(params, serializeObject(value, paramKey_1));
            }
            else {
                params[paramKey_1] = value;
            }
        }
    };
    for (var key in obj) {
...
exports.entityListsApi = baseApi_1.baseApi.injectEndpoints({
    endpoints: function (builder) { return ({
        ...
        updateEntity: builder.mutation({
            query: function (_a) {
                var projectId = _a.projectId, entityId = _a.entityId, update = _a.update;
                return ({
                    url: "/".concat(projectId, "/entities/").concat(entityId),
                    method: "PATCH",
                    body: update,
                });
            },
            invalidatesTags: function (result, error, _a) {
                var projectId = _a.projectId, entityId = _a.entityId;
                return [
                    { type: "Entity", id: entityId },
                    // Invalidate all lists that might contain this entity
                    { type: "Entity", id: "".concat(projectId, "-all-LIST") },
                ];
            },
        }),
        // Delete entity
                ...
                return ({
                    ...
                    responseHandler: function (response) { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            ...
                            return [2 /*return*/, response.text().then(function () { return undefined; })];
                        });
                    }); },
                });
            },
