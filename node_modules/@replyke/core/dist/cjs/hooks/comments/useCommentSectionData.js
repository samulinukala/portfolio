...
var useStableObject_1 = require("../useStableObject");
function useCommentSectionData(props) {
    var _this = this;
    var entityProp = props.entity, entityId = props.entityId, foreignId = props.foreignId, shortId = props.shortId, createIfNotFound = props.createIfNotFound, _a = props.defaultSortBy, defaultSortBy = _a === void 0 ? "top" : _a, _b = props.limit, limit = _b === void 0 ? 15 : _b, _c = props.callbacks, callbacksProp = _c === void 0 ? {} : _c, highlightedCommentId = props.highlightedCommentId;
    // Stabilize callbacks reference to prevent unnecessary re-renders
    var callbacks = (0, useStableObject_1.useStableObject)(callbacksProp);
    ...
    var _f = (0, useEntityComments_1.default)({ entityId: entity === null || entity === void 0 ? void 0 : entity.id, defaultSortBy: defaultSortBy, limit: limit }), entityCommentsTree = _f.entityCommentsTree, comments = _f.comments, newComments = _f.newComments, loading = _f.loading, hasMore = _f.hasMore, sortBy = _f.sortBy, setSortBy = _f.setSortBy, loadMore = _f.loadMore, addCommentsToTree = _f.addCommentsToTree, removeCommentFromTree = _f.removeCommentFromTree;
    ...
    var _g = (0, react_1.useState)(null), highlightedComment = _g[0], setHighlightedComment = _g[1];
    ...
    var _h = (0, react_1.useState)(false), submittingCommentState = _h[0], setSubmittingCommentState = _h[1]; // required to trigger rerenders
    var _j = (0, react_1.useState)(null), pushMention = _j[0], setPushMention = _j[1];
    // const previousPushMention = useRef<null | User>(null);
    var _k = (0, react_1.useState)(null), repliedToComment = _k[0], setRepliedToComment = _k[1];
    var _l = (0, react_1.useState)(false), showReplyBanner = _l[0], setShowReplyBanner = _l[1];
    var _m = (0, react_1.useState)(null), selectedComment = _m[0], setSelectedComment = _m[1];
