...
function useFetchCommentByForeignId() {
    ...
    var fetchCommentByForeignId = (0, react_1.useCallback)(function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
        var response;
        var foreignId = _b.foreignId, withParent = _b.withParent;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios_1.default.get("/".concat(projectId, "/comments/by-foreign-id"), {
                            params: {
