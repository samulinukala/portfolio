...
function useUpdateComment() {
    ...
    var updateComment = (0, react_1.useCallback)(function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
        var requestBody, response;
        var commentId = _b.commentId, content = _b.content, metadata = _b.metadata;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, axios.patch("/".concat(projectId, "/comments/").concat(commentId), requestBody)];
                case 1:
                    response = _c.sent();
