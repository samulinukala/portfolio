...
function useReplies(_a) {
    var _this = this;
    var commentId = _a.commentId, sortBy = _a.sortBy;
    var fetchManyComments = (0, useFetchManyComments_1.default)();
    var _b = (0, useCommentSection_1.default)(), addCommentsToTree = _b.addCommentsToTree, entityCommentsTree = _b.entityCommentsTree;
