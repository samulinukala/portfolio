...
function useEntityList(_a) {
    var _this = this;
    var listId = _a.listId, infuseData = _a.infuseData;
    ...
    var config = (0, react_redux_1.useSelector)(function (state) {
        return (0, entityListsSlice_1.selectEntityListConfig)(state, listId);
    });
    ...
    var handleFetchEntities = (0, react_1.useCallback)(function (newFilters, newConfig, options) {
        // Apply config defaults if not provided
        var configWithDefaults = __assign({ sourceId: null, limit: 10 }, newConfig);
        // Ensure Redux state is initialized and update filters/config
        dispatch((0, entityListsSlice_1.initializeList)({ listId: listId }));
        dispatch((0, entityListsSlice_1.updateFiltersAndSort)({
            listId: listId,
            filters: newFilters,
        ...
        if (options === null || options === void 0 ? void 0 : options.clearImmediately) {
            dispatch((0, entityListsSlice_1.setEntityListEntities)({ listId: listId, entities: [], append: false }));
        }
        ...
        var performFetch = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        currentConfig = { sourceId: configWithDefaults.sourceId, limit: configWithDefaults.limit };
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!config) {
                        console.error("[EntityListRedux] loadMore called before fetchEntities for listId: ".concat(listId, ". ") +
                            "fetchEntities must be called first to initialize configuration.");
                        return [2 /*return*/];
                    }
                    nextPage = entityList.page + 1;
                    dispatch((0, entityListsSlice_1.incrementPage)(listId));
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, entityActions.fetchEntities(listId, {
                ...
                case 3:
                    err_2 = _a.sent();
                    console.error("[EntityListRedux] Failed to load more entities for listId: ".concat(listId), err_2);
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/];
            }
        });
    ...
    var createEntity = (0, react_1.useCallback)(function (_a) { return __awaiter(_this, void 0, void 0, function () {
        var newEntity, err_3;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, entityActions.createEntity(listId, __assign(__assign({}, restOfProps), { sourceId: (config === null || config === void 0 ? void 0 : config.sourceId) || null, insertPosition: insertPosition }))];
                case 1:
                    newEntity = _b.sent();
                ...
                case 2:
                    ...
                    (0, handleError_1.handleError)(err_3, "Failed to create entity");
                    return [3 /*break*/, 3];
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    (0, handleError_1.handleError)(err_4, "Failed to delete entity");
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
    ...
    return (0, react_1.useMemo)(function () { return ({
        ...
        sortDir: (filters === null || filters === void 0 ? void 0 : filters.sortDir) || null,
        sortType: (filters === null || filters === void 0 ? void 0 : filters.sortType) || null,
        timeFrame: (filters === null || filters === void 0 ? void 0 : filters.timeFrame) || null,
        sourceId: (config === null || config === void 0 ? void 0 : config.sourceId) || null,
