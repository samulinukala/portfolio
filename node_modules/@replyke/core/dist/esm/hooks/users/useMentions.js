...
var useMentions = function (_a) {
    ...
    var _b = useState(false), loadingState = _b[0], setLoadingState = _b[1];
    var _c = useState([]), mentions = _c[0], setMentions = _c[1];
    var _d = useState(false), isMentionActive = _d[0], setIsMentionActive = _d[1];
    var _e = useState(""), mentionTrigger = _e[0], setMentionTrigger = _e[1];
    ...
    var handleFetchMentionSuggestions = useCallback(function (query) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    err_1 = _a.sent();
                    handleError(err_1, "Error fetching mentions");
                    return [3 /*break*/, 4];
                case 3:
