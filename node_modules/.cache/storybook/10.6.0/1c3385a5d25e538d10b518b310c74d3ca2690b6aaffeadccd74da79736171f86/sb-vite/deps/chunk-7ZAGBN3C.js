...
import {
  ...
  withReset
} from "./chunk-CD7P32YY.js";
import {
  useMDXComponents
} from "./chunk-HX4ID7YP.js";
import {
  ThemeProvider,
  convert,
  ensure,
  ...
  themes,
  useTheme
} from "./chunk-KQDFRNX3.js";
import {
  require_react_dom
} from "./chunk-4DAMK6EW.js";
import {
  require_react
} from "./chunk-N5Y2CLR6.js";
import {
  __commonJS,
  __toESM
...
// node_modules/@storybook/addon-docs/dist/_browser-chunks/chunk-Q6BGOKFZ.js
var import_react = __toESM(require_react(), 1);
var import_react2 = __toESM(require_react(), 1);
var import_react3 = __toESM(require_react(), 1);
var SNIPPET_WARNING_LABEL = "Incomplete code snippet";
var WarningButton = styled(Button)(({ theme }) => ({
...
var SnippetWarning = ({ warning, className }) => warning?.trim() ? import_react.default.createElement(
  WarningButton,
  {
    className,
  ...
  import_react.default.createElement(AlertIcon, null)
) : null;
function _extends() {
...
var EmptyBlock = (props) => import_react3.default.createElement(Wrapper, { ...props, className: "docblock-emptyblock sb-unstyled" });
...
var PositionedSnippetWarning = styled(SnippetWarning)({
  position: "absolute",
  top: 4,
  right: 4,
  zIndex: 1
});
var SourceWrapper = styled.div({
  position: "relative"
});
...
var Source = ({
  ...
  let highlighter = import_react2.default.createElement(
    ...
    code
  ), syntaxHighlighter = warning ? import_react2.default.createElement(SourceWrapper, null, highlighter, import_react2.default.createElement(PositionedSnippetWarning, { warning })) : highlighter;
  if (typeof dark > "u")
...
var BooleanControl = ({
  ...
  let onSetFalse = (0, import_react8.useCallback)(() => onChange(false), [onChange]), readonly = !!argType?.table?.readonly;
  if (value === void 0)
  ...
  return import_react8.default.createElement(Label, { "aria-disabled": readonly, htmlFor: controlId, "aria-label": name }, import_react8.default.createElement(
    "input",
    {
      id: controlId,
      type: "checkbox",
  ...
  ), import_react8.default.createElement("span", { "aria-hidden": "true" }, "False"), import_react8.default.createElement("span", { "aria-hidden": "true" }, "True"));
};
var parseDate = (value) => {
...
var DateControl = ({
  ...
  let [valid, setValid] = (0, import_react9.useState)(true), dateRef = (0, import_react9.useRef)(), timeRef = (0, import_react9.useRef)(), readonly = !!argType?.table?.readonly;
  ...
  return import_react9.default.createElement(FlexSpaced, null, import_react9.default.createElement("legend", { className: "sb-sr-only" }, name), import_react9.default.createElement("label", { htmlFor: `${controlId}-date`, className: "sb-sr-only" }, "Date"), import_react9.default.createElement(
    FormInput,
    {
      type: "date",
      max: "9999-12-31",
  ...
  ), import_react9.default.createElement("label", { htmlFor: `${controlId}-time`, className: "sb-sr-only" }, "Time"), import_react9.default.createElement(
    FormInput,
    {
      type: "time",
      id: `${controlId}-time`,
  ...
  ), valid ? null : import_react9.default.createElement("div", null, "invalid"));
};
...
var NumberControl = ({
  ...
  let [inputValue, setInputValue] = (0, import_react10.useState)(typeof value == "number" ? value : ""), [forceVisible, setForceVisible] = (0, import_react10.useState)(false), [parseError, setParseError] = (0, import_react10.useState)(null), readonly = !!argType?.table?.readonly, handleChange = (0, import_react10.useCallback)(
    (event) => {
  ...
  return (0, import_react10.useEffect)(() => {
    ...
    "Set number"
  ) : import_react10.default.createElement(Wrapper2, null, import_react10.default.createElement(
    FormInput2,
    {
      ref: htmlElRef,
...
var CheckboxControl = ({
  ...
  if (!options)
    return import_client_logger2.logger.warn(`Checkbox with no options: ${name}`), import_react12.default.createElement(import_react12.default.Fragment, null, "-");
  let initial2 = selectedKeys(value || [], options), [selected, setSelected] = (0, import_react12.useState)(initial2), readonly = !!argType?.table?.readonly, handleChange = (e2) => {
  ...
  return import_react12.default.createElement(Wrapper22, { $isInline: isInline }, import_react12.default.createElement("legend", { className: "sb-sr-only" }, name, required ? " (required)" : ""), Object.keys(options).map((key, index) => {
    let id = `${controlId}-${index}`;
    return import_react12.default.createElement(Label2, { key: id, htmlFor: id, $readOnly: readonly }, import_react12.default.createElement(
      "input",
      {
        type: "checkbox",
        disabled: readonly,
    ...
    ), import_react12.default.createElement(Text, { $readOnly: readonly }, key));
  }));
};
...
var RadioControl = ({
  ...
  if (!options)
    return import_client_logger3.logger.warn(`Radio with no options: ${name}`), import_react13.default.createElement(import_react13.default.Fragment, null, "-");
  let selection = selectedKey(value, options), controlId = getControlId(name, storyId, controlsId), readonly = !!argType?.table?.readonly;
  return import_react13.default.createElement(Wrapper3, { isInline }, import_react13.default.createElement("legend", { className: "sb-sr-only" }, name, required ? " (required)" : ""), Object.keys(options).map((key, index) => {
    let id = `${controlId}-${index}`;
    return import_react13.default.createElement(Label3, { key: id, htmlFor: id, $readOnly: readonly }, import_react13.default.createElement(
      "input",
      {
        type: "radio",
        id,
    ...
    ), import_react13.default.createElement(Text2, { $readOnly: readonly }, key));
  }));
};
var styleResets = {
  // resets
...
var SingleSelect = ({
  ...
  return import_react14.default.createElement(SelectWrapper, null, import_react14.default.createElement(ChevronSmallDownIcon, null), import_react14.default.createElement("label", { htmlFor: controlId, className: "sb-sr-only" }, name), import_react14.default.createElement(
    OptionsSelect,
    {
      disabled: readonly,
      id: controlId,
    ...
    import_react14.default.createElement("option", { disabled: selection === NO_SELECTION, key: "no-selection" }, NO_SELECTION),
    Object.keys(options).map((key) => import_react14.default.createElement("option", { key, value: key }, key))
  ));
};
var MultiSelect = ({
  name,
  ...
  return import_react14.default.createElement(SelectWrapper, null, import_react14.default.createElement("label", { htmlFor: controlId, className: "sb-sr-only" }, name), import_react14.default.createElement(
    OptionsSelect,
    {
      disabled: readonly,
      id: controlId,
...
var SelectControl = (props) => {
  ...
  return options ? props.isMulti ? import_react14.default.createElement(MultiSelect, { ...props }) : import_react14.default.createElement(SingleSelect, { ...props }) : (import_client_logger4.logger.warn(`Select with no options: ${name}`), import_react14.default.createElement(import_react14.default.Fragment, null, "-"));
};
...
var OptionsControl = (props) => {
  ...
  if (Control)
    return import_react11.default.createElement(Control, { ...normalized });
...
function JsonNodeAccordion({
  ...
  return import_react18.default.createElement(Container, { as: containerTag }, import_react18.default.createElement(
    Trigger,
    {
      type: "button",
...
var JsonAddValue = class extends import_react17.Component {
  constructor(props) {
  ...
  render() {
    let {
      ...
      keyPath,
      deep
    } = this.props, addButtonElementLayout = addButtonElement && (0, import_react17.cloneElement)(addButtonElement, {
      onClick: this.onSubmit
    }), cancelButtonElementLayout = cancelButtonElement && (0, import_react17.cloneElement)(cancelButtonElement, {
      onClick: handleCancel
    }), inputElementValue = inputElementGenerator(VALUE, keyPath, deep), inputElementValueLayout = (0, import_react17.cloneElement)(inputElementValue, {
      placeholder: "Value",
    ...
    if (!onlyValue) {
      ...
      inputElementKeyLayout = (0, import_react17.cloneElement)(inputElementKey, {
        placeholder: "Key",
        ref: this.refInputKey,
        onKeyDown: this.onKeydown
      });
    }
    return import_react17.default.createElement("span", { className: "rejt-add-value-node" }, inputElementKeyLayout, inputElementValueLayout, addButtonElementLayout, cancelButtonElementLayout);
  }
};
JsonAddValue.defaultProps = {
  onlyValue: false,
  addButtonElement: import_react17.default.createElement("button", null, "+"),
  cancelButtonElement: import_react17.default.createElement("button", null, "c")
};
var JsonArray = class extends import_react17.Component {
  constructor(props) {
    super(props);
  ...
  renderCollapsed() {
    let { name, data, keyPath, deep } = this.state, { handleRemove, readOnly, dataType, minusMenuElement } = this.props, isReadOnly = readOnly(name, data, keyPath, deep, dataType), removeItemButton = minusMenuElement && (0, import_react17.cloneElement)(minusMenuElement, {
      onClick: handleRemove,
      className: "rejt-minus-menu",
      "aria-label": `remove the array '${String(name)}'`
    });
    return import_react17.default.createElement(import_react17.default.Fragment, null, import_react17.default.createElement("span", { className: "rejt-collapsed-value" }, "[...] ", data.length, " ", data.length === 1 ? "item" : "items"), !isReadOnly && removeItemButton);
  }
  renderNotCollapsed() {
    let { name, data, keyPath, deep, addFormVisible, nextDeep } = this.state, {
      ...
      logger: logger5,
      onSubmitValueParser
    } = this.props, isReadOnly = readOnly(name, data, keyPath, deep, dataType), addItemButton = plusMenuElement && (0, import_react17.cloneElement)(plusMenuElement, {
      onClick: this.handleAddMode,
      className: "rejt-plus-menu",
      "aria-label": `add a new item to the '${String(name)}' array`
    }), removeItemButton = minusMenuElement && (0, import_react17.cloneElement)(minusMenuElement, {
      onClick: handleRemove,
      className: "rejt-minus-menu",
      "aria-label": `remove the array '${String(name)}'`
    });
    return import_react17.default.createElement(import_react17.default.Fragment, null, import_react17.default.createElement("span", { className: "rejt-not-collapsed-delimiter" }, "["), !addFormVisible && addItemButton, import_react17.default.createElement("ul", { className: "rejt-not-collapsed-list" }, data.map((item, index) => import_react17.default.createElement(
      JsonNode,
      {
        key: index,
        name: index.toString(),
    ...
    ))), !isReadOnly && addFormVisible && import_react17.default.createElement("div", { className: "rejt-add-form" }, import_react17.default.createElement(
      JsonAddValue,
      {
    ...
    )), import_react17.default.createElement("span", { className: "rejt-not-collapsed-delimiter" }, "]"), !isReadOnly && removeItemButton);
  }
  render() {
...
JsonArray.defaultProps = {
  keyPath: [],
  deep: 0,
  minusMenuElement: import_react17.default.createElement("span", null, " - "),
  plusMenuElement: import_react17.default.createElement("span", null, " + ")
};
var JsonFunctionValue = class extends import_react17.Component {
  constructor(props) {
    super(props);
    let keyPath = [...props.keyPath || [], props.name];
    this.state = {
  ...
  render() {
    ...
    if (editEnabled && !resultOnlyResult) {
      let textareaElement = textareaElementGenerator(
        ...
        originalValue,
        dataType
      ), textareaElementLayout = (0, import_react17.cloneElement)(textareaElement, {
        ref: this.refInput,
        defaultValue: value,
        onKeyDown: this.onKeydown
      });
      result = import_react17.default.createElement("span", { className: "rejt-edit-form" }, textareaElementLayout), minusElement = null;
    } else {
      result = import_react17.default.createElement("span", { className: "rejt-value", onClick: resultOnlyResult ? void 0 : this.handleEditMode }, value);
      let parentPropertyName = comeFromKeyPath.at(-1), minusMenuLayout = minusMenuElement && (0, import_react17.cloneElement)(minusMenuElement, {
        onClick: handleRemove,
        className: "rejt-minus-menu",
    ...
    return import_react17.default.createElement("li", { className: "rejt-value-node" }, import_react17.default.createElement("span", { className: "rejt-name" }, name, " : "), result, minusElement);
  }
};
...
var JsonNode = class extends import_react17.Component {
  constructor(props) {
    super(props), this.state = {
      data: props.data,
      name: props.name,
...
var JsonObject = class extends import_react17.Component {
  constructor(props) {
    super(props);
  ...
  renderCollapsed() {
    let { name, keyPath, deep, data } = this.state, { handleRemove, readOnly, dataType, minusMenuElement } = this.props, keyList = Object.getOwnPropertyNames(data), isReadOnly = readOnly(name, data, keyPath, deep, dataType), removeItemButton = minusMenuElement && (0, import_react17.cloneElement)(minusMenuElement, {
      onClick: handleRemove,
      className: "rejt-minus-menu",
      "aria-label": `remove the object '${String(name)}'`
    });
    return import_react17.default.createElement(import_react17.default.Fragment, null, import_react17.default.createElement("span", { className: "rejt-collapsed-value" }, "{...}", " ", keyList.length, " ", keyList.length === 1 ? "key" : "keys"), !isReadOnly && removeItemButton);
  }
  renderNotCollapsed() {
    let { name, data, keyPath, deep, nextDeep, addFormVisible } = this.state, {
      ...
      logger: logger5,
      onSubmitValueParser
    } = this.props, keyList = Object.getOwnPropertyNames(data), isReadOnly = readOnly(name, data, keyPath, deep, dataType), addItemButton = plusMenuElement && (0, import_react17.cloneElement)(plusMenuElement, {
      onClick: this.handleAddMode,
      className: "rejt-plus-menu",
      ...
      className: "rejt-minus-menu",
      "aria-label": `remove the object '${String(name)}'`
    }), list = keyList.map((key) => import_react17.default.createElement(
      JsonNode,
      {
        key,
        name: key,
    ...
    return import_react17.default.createElement(import_react17.default.Fragment, null, import_react17.default.createElement("span", { className: "rejt-not-collapsed-delimiter" }, "{"), !isReadOnly && addItemButton, import_react17.default.createElement("ul", { className: "rejt-not-collapsed-list" }, list), !isReadOnly && addFormVisible && import_react17.default.createElement("div", { className: "rejt-add-form" }, import_react17.default.createElement(
      JsonAddValue,
      {
        handleAdd: this.handleAddValueAdd,
        handleCancel: this.handleAddValueCancel,
...
var JsonValue = class extends import_react17.Component {
  constructor(props) {
    super(props);
    let keyPath = [...props.keyPath || [], props.name];
    this.state = {
  ...
  render() {
    let { name, value, editEnabled, keyPath, deep } = this.state, {
      ...
      originalValue,
      dataType
    ), inputElementLayout = (0, import_react17.cloneElement)(inputElement, {
      ref: this.refInput,
      defaultValue: JSON.stringify(originalValue),
      onKeyDown: this.onKeydown
    }), parentPropertyName = keyPath.at(-2), minusMenuLayout = minusMenuElement && (0, import_react17.cloneElement)(minusMenuElement, {
      onClick: handleRemove,
      className: "rejt-minus-menu",
    ...
    return import_react17.default.createElement("li", { className: "rejt-value-node" }, import_react17.default.createElement("span", { className: "rejt-name" }, name, " : "), isEditing ? import_react17.default.createElement("span", { className: "rejt-edit-form" }, inputElementLayout) : import_react17.default.createElement("span", { className: "rejt-value", onClick: isReadOnly ? void 0 : this.handleEditMode }, String(value)), !isReadOnly && !isEditing && minusMenuLayout);
  }
};
...
var JsonTree = class extends import_react16.Component {
  constructor(props) {
    super(props), this.state = {
      data: props.data,
  ...
  render() {
    ...
    return textareaElement && getObjectType(textareaElement) !== "Function" && (textareaElementFunction = () => textareaElement), dataType === "Object" || dataType === "Array" ? import_react16.default.createElement("div", { className: "rejt-tree" }, import_react16.default.createElement(
      JsonNode,
      {
        data,
        name: rootName || "root",
...
JsonTree.defaultProps = {
  ...
  inputElement: () => import_react16.default.createElement("input", null),
  textareaElement: () => import_react16.default.createElement("textarea", null),
  fallback: null
};
...
var ObjectControl = ({
  ...
  let data = (0, import_react15.useMemo)(() => value && cloneDeep(value), [value]), hasData = data != null, [showRaw, setShowRaw] = (0, import_react15.useState)(!hasData), hadDataRef = (0, import_react15.useRef)(hasData), [parseError, setParseError] = (0, import_react15.useState)(null), readonly = !!argType?.table?.readonly, updateRaw = (0, import_react15.useCallback)(
    (raw) => {
      try {
    ...
    [onChange]
  ), [forceVisible, setForceVisible] = (0, import_react15.useState)(false), onForceVisible = (0, import_react15.useCallback)(() => {
  ...
  let htmlElRef = (0, import_react15.useRef)(null);
  (0, import_react15.useEffect)(() => {
    forceVisible && htmlElRef.current && htmlElRef.current.select();
  }, [forceVisible]);
  let jsonString = (0, import_react15.useMemo)(() => JSON.stringify(data ?? "", null, 2), [data]);
  if (!hasData)
  ...
  let rawInputId = getControlId(name, storyId, controlsId), rawJSONForm = import_react15.default.createElement(import_react15.default.Fragment, null, import_react15.default.createElement("label", { htmlFor: rawInputId, className: "sb-sr-only" }, "Edit ", name, " as JSON"), import_react15.default.createElement(
    RawInput,
    {
      ref: htmlElRef,
      id: rawInputId,
  ...
  return import_react15.default.createElement(Wrapper4, null, isObjectOrArray && import_react15.default.createElement(
    RawButton,
    {
      disabled: readonly,
      pressed: showRaw,
    ...
    import_react15.default.createElement(EditIcon, null)
  ), showRaw ? rawJSONForm : import_react15.default.createElement(
    JsonTree,
    {
      ...
      cancelButtonElement: import_react15.default.createElement(ButtonInline, { type: "button" }, "Cancel"),
      addButtonElement: import_react15.default.createElement(ButtonInline, { type: "submit", primary: true }, "Save"),
      plusMenuElement: import_react15.default.createElement(ActionButton, { type: "button" }, import_react15.default.createElement(AddIcon, null)),
      minusMenuElement: import_react15.default.createElement(ActionButton, { type: "button" }, import_react15.default.createElement(SubtractIcon, null)),
      inputElement: (_2, __, ___, key) => key ? import_react15.default.createElement(Input, { onFocus: selectValue, onBlur: dispatchEnterKey }) : import_react15.default.createElement(Input, null),
...
var RangeControl = ({
  ...
  }, hasValue = value !== void 0, numberOFDecimalsPlaces = (0, import_react19.useMemo)(() => getNumberOfDecimalPlaces(step), [step]), readonly = !!argType?.table?.readonly, controlId = getControlId(name, storyId, controlsId);
  return import_react19.default.createElement(RangeWrapper, { readOnly: readonly }, import_react19.default.createElement("label", { htmlFor: controlId, className: "sb-sr-only" }, name), import_react19.default.createElement(RangeLabel, null, min), import_react19.default.createElement(
    RangeInput,
    {
      id: controlId,
      type: "range",
  ...
  ), import_react19.default.createElement(RangeCurrentAndMaxLabel, { numberOFDecimalsPlaces, max }, hasValue ? value.toFixed(numberOFDecimalsPlaces) : "--", " / ", max));
};
...
var TextControl = ({
  ...
  }, readonly = !!argType?.table?.readonly, [forceVisible, setForceVisible] = (0, import_react20.useState)(false), onForceVisible = (0, import_react20.useCallback)(() => {
    onChange(""), setForceVisible(true);
  }, [setForceVisible]);
  if (value === void 0)
  ...
  return import_react20.default.createElement(Wrapper5, null, import_react20.default.createElement(
    Form.Textarea,
    {
      id: getControlId(name, storyId, controlsId),
      maxLength,
  ...
  ), maxLength && import_react20.default.createElement(MaxLength, { isMaxed: value?.length === maxLength }, value?.length ?? 0, " / ", maxLength));
};
...
var FilesControl = ({
  ...
  let inputElement = (0, import_react21.useRef)(null), readonly = argType?.control?.readOnly;
  ...
  let controlId = getControlId(name, storyId, controlsId);
  return import_react21.default.createElement(import_react21.default.Fragment, null, import_react21.default.createElement("label", { htmlFor: controlId, className: "sb-sr-only" }, name), import_react21.default.createElement(
    FileInput,
    {
      ref: inputElement,
      id: controlId,
...
var LazyColorControl = (0, import_react7.lazy)(() => import("./Color-6AOWCN3U-XRKHUOLE.js"));
var ColorControl = (props) => import_react7.default.createElement(import_react7.Suspense, { fallback: import_react7.default.createElement("div", null) }, import_react7.default.createElement(LazyColorControl, { ...props }));
var Controls2 = {
  array: ObjectControl,
...
var NoControl = () => import_react6.default.createElement(import_react6.default.Fragment, null, "-");
var ArgControl = ({
  row,
  arg,
  updateArgs,
  ...
  let { key, control } = row, [isFocused, setFocused] = (0, import_react6.useState)(false), [boxedValue, setBoxedValue] = (0, import_react6.useState)({ value: arg });
  (0, import_react6.useEffect)(() => {
    isFocused || setBoxedValue({ value: arg });
  }, [isFocused, arg]);
  let onChange = (0, import_react6.useCallback)(
    (argVal) => (setBoxedValue({ value: argVal }), updateArgs({ [key]: argVal }), argVal),
    [updateArgs, key]
  ), onBlur = (0, import_react6.useCallback)(() => setFocused(false), []), onFocus = (0, import_react6.useCallback)(() => setFocused(true), []);
  if (!control || control.disable)
    return control?.disable !== true && row?.type?.name !== "function" ? import_react6.default.createElement(import_react6.default.Fragment, null, import_react6.default.createElement("span", { className: "sbdocs sbdocs-argcontrol-setup" }, import_react6.default.createElement(
      Link2,
      {
      ...
      "Setup controls"
    )), import_react6.default.createElement("span", { className: "sbdocs sbdocs-argcontrol-placeholder" }, import_react6.default.createElement(NoControl, null))) : import_react6.default.createElement(NoControl, null);
  let props = {
    name: key,
    storyId,
    controlsId,
  ...
  return import_react6.default.createElement(Control, { ...props, ...control, controlType: control.type });
};
...
var ArgJsDoc = ({ tags }) => {
  ...
  return !hasDisplayableParams && !hasDisplayableReturns && !hasDisplayableDeprecated ? null : import_react22.default.createElement(import_react22.default.Fragment, null, import_react22.default.createElement(Table, null, import_react22.default.createElement("tbody", null, hasDisplayableDeprecated && import_react22.default.createElement("tr", { key: "deprecated" }, import_react22.default.createElement("td", { colSpan: 2 }, import_react22.default.createElement("strong", null, "Deprecated"), ": ", tags.deprecated?.toString())), hasDisplayableParams && params.map((x2) => import_react22.default.createElement("tr", { key: x2.name }, import_react22.default.createElement("td", null, import_react22.default.createElement("code", null, x2.name)), import_react22.default.createElement("td", null, x2.description))), hasDisplayableReturns && import_react22.default.createElement("tr", { key: "returns" }, import_react22.default.createElement("td", null, import_react22.default.createElement("code", null, "Returns")), import_react22.default.createElement("td", null, tags.returns?.description)))));
};
function uniq(arr) {
  return [...new Set(arr)];
}
...
var EmptyArg = () => import_react23.default.createElement("span", null, "-");
var ArgText = ({ text, simple }) => import_react23.default.createElement(Text3, { simple }, text);
...
var renderSummaryItems = (summaryItems) => summaryItems.slice(0, ITEMS_BEFORE_EXPANSION).map((item) => import_react23.default.createElement(ArgText, { key: item, text: item === "" ? '""' : item }));
var renderExpandedItems = (summaryItems) => summaryItems.slice(ITEMS_BEFORE_EXPANSION).map((item) => import_react23.default.createElement(ArgText, { key: item, text: item === "" ? '""' : item }));
var ArgSummary = ({ value, initialExpandedArgs }) => {
  let { summary, detail } = value, [isOpen, setIsOpen] = (0, import_react23.useState)(false), [isExpanded, setIsExpanded] = (0, import_react23.useState)(initialExpandedArgs || false);
  if (summary == null)
    return null;
  let summaryAsString = typeof summary.toString == "function" ? summary.toString() : summary;
  if (detail == null) {
    if (/[(){}[\]<>]/.test(summaryAsString))
      return import_react23.default.createElement(ArgText, { text: summaryAsString });
    let summaryItems = getSummaryItems(summaryAsString), itemsCount = summaryItems.length;
    return itemsCount > ITEMS_BEFORE_EXPANSION ? import_react23.default.createElement(Summary, { isExpanded }, renderSummaryItems(summaryItems), import_react23.default.createElement(DetailsContainer, { open: isExpanded, onToggle: (e2) => setIsExpanded(e2.currentTarget.open) }, import_react23.default.createElement(AlignedDetails, null, renderExpandedItems(summaryItems)), import_react23.default.createElement(ExpandButton, { role: "button" }, isExpanded ? "Show less..." : `Show ${itemsCount - ITEMS_BEFORE_EXPANSION} more...`))) : import_react23.default.createElement(Summary, null, renderSummaryItems(summaryItems));
  }
  return import_react23.default.createElement(
    PopoverProvider,
    {
      ...
      hasCloseButton: true,
      popover: import_react23.default.createElement(Detail, null, import_react23.default.createElement(SyntaxHighlighter, { language: "jsx", format: false }, detail))
    },
    import_react23.default.createElement(Expandable, { className: "sbdocs-expandable" }, import_react23.default.createElement("span", null, summaryAsString), isOpen ? import_react23.default.createElement(ChevronUpIcon, null) : import_react23.default.createElement(ChevronDownIcon2, null))
  );
};
var ArgValue = ({ value, initialExpandedArgs }) => value == null ? import_react23.default.createElement(EmptyArg, null) : import_react23.default.createElement(ArgSummary, { value, initialExpandedArgs });
...
var ArgRow = (props) => {
  ...
  return import_react5.default.createElement(StyledTr, null, import_react5.default.createElement(StyledTd, { expandable: expandable ?? false }, import_react5.default.createElement(Name, null, name), required ? import_react5.default.createElement(Required, { "aria-hidden": true, title: "Required" }, "*") : null), compact2 ? null : import_react5.default.createElement("td", null, hasDescription && import_react5.default.createElement(Description, { lang: docsLang }, import_react5.default.createElement(index_modern_default, null, description)), table.jsDocTags != null ? import_react5.default.createElement(import_react5.default.Fragment, null, import_react5.default.createElement(TypeWithJsDoc, { hasDescription }, import_react5.default.createElement(ArgValue, { value: type, initialExpandedArgs })), import_react5.default.createElement(ArgJsDoc, { tags: table.jsDocTags })) : import_react5.default.createElement(Type, { hasDescription }, import_react5.default.createElement(ArgValue, { value: type, initialExpandedArgs }))), compact2 ? null : import_react5.default.createElement("td", null, import_react5.default.createElement(ArgValue, { value: defaultValue, initialExpandedArgs })), updateArgs ? import_react5.default.createElement("td", null, import_react5.default.createElement(ArgControl, { ...props, isRequired: !!required })) : null);
};
...
var Empty = ({ inAddonPanel }) => {
  let [isLoading, setIsLoading] = (0, import_react24.useState)(true);
  return (0, import_react24.useEffect)(() => {
    let load = setTimeout(() => {
      setIsLoading(false);
    }, 100);
    return () => clearTimeout(load);
  }, []), isLoading ? null : import_react24.default.createElement(Wrapper6, { inAddonPanel }, import_react24.default.createElement(
    EmptyTabContent,
    {
      title: "This story has no controls",
      description: import_react24.default.createElement(import_react24.default.Fragment, null, "Storybook couldn't find or generate any controls for this story. Define", " ", import_react24.default.createElement("code", null, "args"), " or ", import_react24.default.createElement("code", null, "argTypes"), ", or configure docgen to let Storybook generate controls automatically."),
      footer: import_react24.default.createElement(Links, null, import_react24.default.createElement(
        Link2,
        {
          href: "https://storybook.js.org/docs/essentials/controls?ref=ui",
          target: "_blank",
        ...
        import_react24.default.createElement(DocumentIcon, null),
        " Read docs"
      ))
    }
  ));
...
var SectionRow = ({
  ...
  let [expanded, setExpanded] = (0, import_react25.useState)(initialExpanded), Level = level === "subsection" ? Subsection : Section, itemCount = children?.length || 0, caption = level === "subsection" ? `${itemCount} item${itemCount !== 1 ? "s" : ""}` : "", helperText = `${expanded ? "Hide" : "Show"} ${level === "subsection" ? itemCount : label} item${itemCount !== 1 ? "s" : ""}`;
  return import_react25.default.createElement(import_react25.default.Fragment, null, import_react25.default.createElement(StyledTr2, { title: helperText }, import_react25.default.createElement(Level, { colSpan: 1 }, import_react25.default.createElement(ClickIntercept, { onClick: (e2) => setExpanded(!expanded), tabIndex: 0 }, helperText), import_react25.default.createElement(FlexWrapper, null, expanded ? import_react25.default.createElement(ExpanderIconDown, null) : import_react25.default.createElement(ExpanderIconRight, null), label)), import_react25.default.createElement(StyledTd2, { colSpan: colSpan - 1 }, import_react25.default.createElement(
    ClickIntercept,
    {
...
var Skeleton = () => import_react26.default.createElement(TableWrapper, null, import_react26.default.createElement(Row, null, import_react26.default.createElement(Column, { position: "first" }, import_react26.default.createElement(SkeletonText, { width: "60%" })), import_react26.default.createElement(Column, { position: "second" }, import_react26.default.createElement(SkeletonText, { width: "30%" })), import_react26.default.createElement(Column, { position: "third" }, import_react26.default.createElement(SkeletonText, { width: "60%" })), import_react26.default.createElement(Column, { position: "last" }, import_react26.default.createElement(SkeletonText, { width: "60%" }))), import_react26.default.createElement(Row, null, import_react26.default.createElement(Column, { position: "first" }, import_react26.default.createElement(SkeletonText, { width: "60%" })), import_react26.default.createElement(Column, { position: "second" }, import_react26.default.createElement(SkeletonText, { width: "80%" }), import_react26.default.createElement(SkeletonText, { width: "30%" })), import_react26.default.createElement(Column, { position: "third" }, import_react26.default.createElement(SkeletonText, { width: "60%" })), import_react26.default.createElement(Column, { position: "last" }, import_react26.default.createElement(SkeletonText, { width: "60%" }))), import_react26.default.createElement(Row, null, import_react26.default.createElement(Column, { position: "first" }, import_react26.default.createElement(SkeletonText, { width: "60%" })), import_react26.default.createElement(Column, { position: "second" }, import_react26.default.createElement(SkeletonText, { width: "80%" }), import_react26.default.createElement(SkeletonText, { width: "30%" })), import_react26.default.createElement(Column, { position: "third" }, import_react26.default.createElement(SkeletonText, { width: "60%" })), import_react26.default.createElement(Column, { position: "last" }, import_react26.default.createElement(SkeletonText, { width: "60%" }))), import_react26.default.createElement(Row, null, import_react26.default.createElement(Column, { position: "first" }, import_react26.default.createElement(SkeletonText, { width: "60%" })), import_react26.default.createElement(Column, { position: "second" }, import_react26.default.createElement(SkeletonText, { width: "80%" }), import_react26.default.createElement(SkeletonText, { width: "30%" })), import_react26.default.createElement(Column, { position: "third" }, import_react26.default.createElement(SkeletonText, { width: "60%" })), import_react26.default.createElement(Column, { position: "last" }, import_react26.default.createElement(SkeletonText, { width: "60%" }))));
...
var ArgsTable = (props) => {
  let {
    ...
    controlsId,
    docsLang
  } = props, { rows, args, globals } = "rows" in props ? props : { rows: void 0, args: void 0, globals: void 0 }, isResettingRef = (0, import_react4.useRef)(false), [isResetting, setIsResetting] = (0, import_react4.useState)(false);
  (0, import_react4.useEffect)(() => {
    isResettingRef.current = false, setIsResetting(false);
  }, [args]);
  let handleResetClick = (0, import_react4.useCallback)(() => {
    !isResettingRef.current && resetArgs && (isResettingRef.current = true, setIsResetting(true), resetArgs());
  }, [resetArgs]);
  if ("error" in props) {
    let { error } = props;
    return import_react4.default.createElement(EmptyBlock, null, error, " ", import_react4.default.createElement(Link2, { href: "http://storybook.js.org/docs/?ref=ui", target: "_blank", withArrow: true }, import_react4.default.createElement(DocumentIcon, null), " Read the docs"));
  }
  if (isLoading)
    return import_react4.default.createElement(Skeleton, null);
  ...
  if (hasNoUngrouped && hasNoSections && hasNoUngroupedSubsections)
    return import_react4.default.createElement(Empty, { inAddonPanel });
  let colSpan = 1;
  ...
  return import_react4.default.createElement(ResetWrapper, null, import_react4.default.createElement(TablePositionWrapper, null, updateArgs && !isLoading && resetArgs && import_react4.default.createElement(ButtonPositionWrapper, null, import_react4.default.createElement(
    StyledButton,
    {
      variant: "ghost",
      padding: "small",
    ...
    import_react4.default.createElement(UndoIcon, null)
    ...
    import_react4.default.createElement("thead", { className: "docblock-argstable-head" }, import_react4.default.createElement("tr", null, import_react4.default.createElement("th", null, import_react4.default.createElement("span", null, "Name")), compact2 ? null : import_react4.default.createElement("th", null, import_react4.default.createElement("span", null, "Description")), compact2 ? null : import_react4.default.createElement("th", null, import_react4.default.createElement("span", null, "Default")), updateArgs ? import_react4.default.createElement("th", null, import_react4.default.createElement("span", null, "Control")) : null)),
    import_react4.default.createElement("tbody", { className: "docblock-argstable-body" }, groups.ungrouped.map((row) => import_react4.default.createElement(
      ArgRow,
      {
        key: row.key,
        row,
    ...
    )), Object.entries(groups.ungroupedSubsections).map(([subcategory, subsection]) => import_react4.default.createElement(
      SectionRow,
      {
        key: subcategory,
        label: subcategory,
      ...
      subsection.map((row) => import_react4.default.createElement(
        ArgRow,
        {
          key: row.key,
          row,
    ...
    )), Object.entries(groups.sections).map(([category, section]) => import_react4.default.createElement(SectionRow, { key: category, label: category, level: "section", colSpan }, section.ungrouped.map((row) => import_react4.default.createElement(ArgRow, { key: row.key, row, arg: args && args[row.key], ...common })), Object.entries(section.subsections).map(([subcategory, subsection]) => import_react4.default.createElement(
      SectionRow,
      {
        key: subcategory,
        label: subcategory,
...
var DocsPageWrapper = ({ children, toc, lang = "en" }) => import_react27.default.createElement(DocsWrapper, { className: "sbdocs sbdocs-wrapper" }, toc, import_react27.default.createElement(DocsContent, { className: "sbdocs sbdocs-content", lang }, children));
var $f0a04ccd8dbdd83b$export$e5c5a5f917a5871c = typeof document < "u" ? import_react29.default.useLayoutEffect : () => {
};
var $b5e257d569688ac6$var$defaultContext = {
  prefix: String(Math.round(Math.random() * 1e10)),
  current: 0
};
var $b5e257d569688ac6$var$SSRContext = import_react32.default.createContext($b5e257d569688ac6$var$defaultContext);
var $b5e257d569688ac6$var$IsSSRContext = import_react32.default.createContext(false);
var $b5e257d569688ac6$var$canUseDOM = !!(typeof window < "u" && window.document && window.document.createElement);
var $b5e257d569688ac6$var$componentIds = /* @__PURE__ */ new WeakMap();
function $b5e257d569688ac6$var$useCounter(isDisabled = false) {
  let ctx = (0, import_react32.useContext)($b5e257d569688ac6$var$SSRContext), ref = (0, import_react32.useRef)(null);
  if (ref.current === null && !isDisabled) {
    var _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner, _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    let currentOwner = (_React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = import_react32.default.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED) === null || _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED === void 0 || (_React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner = _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner) === null || _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner === void 0 ? void 0 : _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner.current;
    if (currentOwner) {
...
function $b5e257d569688ac6$var$useModernSSRSafeId(defaultId) {
  let id = import_react32.default.useId(), [didSSR] = (0, import_react32.useState)($b5e257d569688ac6$export$535bd6ca7f90a273()), prefix = didSSR || false ? "react-aria" : `react-aria${$b5e257d569688ac6$var$defaultContext.prefix}`;
  return defaultId || `${prefix}-${id}`;
}
var $b5e257d569688ac6$export$619500959fc48b26 = typeof import_react32.default.useId == "function" ? $b5e257d569688ac6$var$useModernSSRSafeId : $b5e257d569688ac6$var$useLegacySSRSafeId;
...
function $b5e257d569688ac6$export$535bd6ca7f90a273() {
  return typeof import_react32.default.useSyncExternalStore == "function" ? import_react32.default.useSyncExternalStore($b5e257d569688ac6$var$subscribe, $b5e257d569688ac6$var$getSnapshot, $b5e257d569688ac6$var$getServerSnapshot) : (0, import_react32.useContext)($b5e257d569688ac6$var$IsSSRContext);
}
...
function $bdb11010cef70236$export$f680877a34711e37(defaultId) {
  let [value, setValue] = (0, import_react31.useState)(defaultId), nextId = (0, import_react31.useRef)(null), res = $b5e257d569688ac6$export$619500959fc48b26(value), cleanupRef = (0, import_react31.useRef)(null);
...
var $ea8dcbcb9ea1b556$var$RouterContext = (0, import_react33.createContext)({
  isNative: true,
...
var $8ae05eaa5c114e9c$var$useEarlyEffect = ($8ae05eaa5c114e9c$var$_React_useInsertionEffect = import_react37.default.useInsertionEffect) !== null && $8ae05eaa5c114e9c$var$_React_useInsertionEffect !== void 0 ? $8ae05eaa5c114e9c$var$_React_useInsertionEffect : $f0a04ccd8dbdd83b$export$e5c5a5f917a5871c;
...
var $458b0a5536c1a7cf$var$useEarlyEffect = typeof document < "u" ? ($458b0a5536c1a7cf$var$_React_useInsertionEffect = import_react50.default.useInsertionEffect) !== null && $458b0a5536c1a7cf$var$_React_useInsertionEffect !== void 0 ? $458b0a5536c1a7cf$var$_React_useInsertionEffect : import_react50.default.useLayoutEffect : () => {
};
globalThis && globalThis.__DOCS_CONTEXT__ === void 0 && (globalThis.__DOCS_CONTEXT__ = (0, import_react51.createContext)(null), globalThis.__DOCS_CONTEXT__.displayName = "DocsContext");
var DocsContext = globalThis ? globalThis.__DOCS_CONTEXT__ : (0, import_react51.createContext)(null);
function useStory(storyId, context) {
  let stories = useStories([storyId], context);
  return stories && stories[0];
}
function useStories(storyIds, context) {
  let [storiesById, setStories] = (0, import_react53.useState)({});
...
var MdxWrappedBlockContext = import_react54.default.createContext(null);
var withMdxComponentOverride = (blockName, Block) => {
  let WrappedBlock = (props) => {
    let wrappedBlocks = import_react54.default.useContext(MdxWrappedBlockContext), Override = useMDXComponents()[blockName];
    if (wrappedBlocks?.has(blockName) || Override === WrappedBlock)
      return import_react54.default.createElement(Block, { ...props });
    if (Override) {
      let nextWrappedBlocks = new Set(wrappedBlocks ?? []);
      return nextWrappedBlocks.add(blockName), import_react54.default.createElement(MdxWrappedBlockContext.Provider, { value: nextWrappedBlocks }, import_react54.default.createElement(Override, { ...props }));
    }
    return import_react54.default.createElement(Block, { ...props });
  };
...
var StoryImpl = (props = { __forceInitialArgs: false, __primary: false }) => {
  let context = (0, import_react52.useContext)(DocsContext), storyId = getStoryId(props, context), story = useStory(storyId, context);
  if (!story)
    return import_react52.default.createElement(StorySkeleton, null);
  let storyProps = getStoryProps(props, story, context);
  return storyProps ? import_react52.default.createElement(Story, { ...storyProps }) : null;
};
...
var IFrame = class extends import_react57.Component {
  constructor() {
    super(...arguments);
    this.iframe = null;
  }
...
var ZoomContext = (0, import_react58.createContext)({
  scale: 1
});
var storyBlockIdFromId = ({ story, primary }) => `story--${story.id}${primary ? "--primary" : ""}`;
var InlineStory = (props) => {
  let storyRef = (0, import_react56.useRef)(), [showLoader, setShowLoader] = (0, import_react56.useState)(true), [error, setError] = (0, import_react56.useState)(), { story, height, autoplay, forceInitialArgs, renderStoryToElement } = props;
  ...
  }, [autoplay, renderStoryToElement, story]), error ? import_react56.default.createElement("pre", null, import_react56.default.createElement(ErrorFormatter, { error })) : import_react56.default.createElement(import_react56.default.Fragment, null, height ? import_react56.default.createElement("style", null, `#${storyBlockIdFromId(
    props
  )} { min-height: ${height}; transform: translateZ(0); overflow: auto }`) : null, showLoader && import_react56.default.createElement(StorySkeleton, null), import_react56.default.createElement(
    "div",
    {
      ref: storyRef,
...
var IFrameStory = ({ story, height = "500px" }) => import_react56.default.createElement("div", { style: { width: "100%", height } }, import_react56.default.createElement(ZoomContext.Consumer, null, ({ scale }) => import_react56.default.createElement(
  IFrame,
  {
    key: "iframe",
    id: `iframe--${story.id}`,
...
var Story = (props) => {
  ...
  return inline && !props.autoplay && story.usesMount ? import_react56.default.createElement(ErrorMessage, null, "This story mounts inside of play. Set", " ", import_react56.default.createElement("a", { href: "https://storybook.js.org/docs/api/doc-blocks/doc-block-story?ref=ui#autoplay" }, "autoplay"), " ", "to true to view this story.") : import_react56.default.createElement("div", { id: storyBlockIdFromId(props), className: "sb-story sb-unstyled", "data-story-block": "true" }, inline ? import_react56.default.createElement(InlineStory, { ...props }) : import_react56.default.createElement(IFrameStory, { ...props }));
};
var StorySkeleton = () => import_react56.default.createElement(Loader, null);
var TRAILING_INSET = 10;
...
var Toolbar2 = ({
  ...
  import_react59.default.createElement(Wrapper7, { key: "left" }, isLoading ? [1, 2, 3].map((key) => import_react59.default.createElement(IconPlaceholder, { key })) : import_react59.default.createElement(import_react59.default.Fragment, null, onReloadStory && import_react59.default.createElement(
    Button,
    {
      padding: "small",
      variant: "ghost",
    ...
    import_react59.default.createElement(SyncIcon, null)
  ), import_react59.default.createElement(
    Button,
    {
      padding: "small",
    ...
    import_react59.default.createElement(ZoomIcon, null)
  ), import_react59.default.createElement(
    Button,
    {
      padding: "small",
    ...
    import_react59.default.createElement(ZoomOutIcon, null)
  ), import_react59.default.createElement(
    Button,
    {
      padding: "small",
    ...
    import_react59.default.createElement(ZoomResetIcon, null)
  ))),
  isLoading ? import_react59.default.createElement(Wrapper7, { key: "right" }, import_react59.default.createElement(IconPlaceholder, null)) : storyId && import_react59.default.createElement(Wrapper7, { key: "right" }, import_react59.default.createElement(
    Button,
    {
      asChild: true,
      padding: "small",
    ...
    import_react59.default.createElement("a", { href: getStoryHref(storyId), target: "_blank", rel: "noopener noreferrer" }, import_react59.default.createElement(ShareAltIcon, null))
  ))
);
...
var TrailingSnippetWarning = styled(SnippetWarning)({
...
function getChildProps(children) {
  if (import_react28.Children.count(children) === 1) {
    let elt = children;
    if (elt.props)
      return elt.props;
  }
...
var Preview = ({
  ...
  let [expanded, setExpanded] = (0, import_react28.useState)(isExpanded), [copied, setCopied] = (0, import_react28.useState)(null), [scale, setScale] = (0, import_react28.useState)(1), additionalActionItems = (0, import_react28.useMemo)(
    () => additionalActions ? [...additionalActions] : [],
    [additionalActions]
  ), sourceId = $bdb11010cef70236$export$f680877a34711e37(), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), context = (0, import_react28.useContext)(DocsContext), copyToClipboard = (0, import_react28.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./components-GC2MKN6T.js");
    await createCopyToClipboardFunction()(text);
  }, []), handleCopyCode = (0, import_react28.useCallback)(async () => {
    try {
  ...
  return import_react28.default.createElement(import_react28.default.Fragment, null, import_react28.default.createElement(
    PreviewContainer,
    {
      withSource,
      withToolbar,
    ...
    withToolbar && import_react28.default.createElement(
      PositionedToolbar,
      {
        isLoading,
        border: true,
    ...
    import_react28.default.createElement(ZoomContext.Provider, { value: { scale } }, import_react28.default.createElement(
      ChildrenContainer,
      {
      ...
      import_react28.default.createElement(Zoom.Element, { centered: layout === "centered", scale: inline ? scale : 1 }, Array.isArray(children) ? children.map((child, i2) => import_react28.default.createElement("div", { key: i2 }, child)) : import_react28.default.createElement("div", null, children))
    )),
    hasValidSource && expanded && import_react28.default.createElement("div", { id: sourceId }, import_react28.default.createElement(StyledSource, { ...sourceProps, dark: true, copyable: false }))
  ), (withSource || additionalActionItems.length > 0) && import_react28.default.createElement(ActionBar, { className: "sbdocs sbdocs-preview-actions", innerStyle: { paddingInline: 0 } }, hasSourceError && import_react28.default.createElement(
    Button,
    {
      lang: "en",
      ariaLabel: false,
    ...
    import_react28.default.createElement(MarkupIcon, null),
    " No code available"
  ), hasValidSource && import_react28.default.createElement(import_react28.default.Fragment, null, import_react28.default.createElement(
    ToggleButton,
    {
      lang: "en",
      ariaLabel: false,
  ...
  ), import_react28.default.createElement(Button, { lang: "en", ariaLabel: false, variant: "ghost", onClick: handleCopyCode }, import_react28.default.createElement(CopyIcon, null), " ", copied ?? "Copy code")), additionalActionItems.map(
    ({ title, ariaLabel, className: className2, onClick, disabled }, index) => import_react28.default.createElement(
      Button,
      {
        key: index,
  ...
  ), hasValidSource && import_react28.default.createElement(TrailingSnippetWarning, { warning: sourceWarning })));
};
...
var TabbedArgsTable = ({ tabs, ...props }) => {
  ...
  if (entries.length === 1)
    return import_react60.default.createElement(ArgsTable, { ...entries[0][1], ...props });
  let tabsFromEntries = entries.map(([label, table], index) => {
    ...
    return {
      ...
      title: label,
      children: import_react60.default.createElement(ArgsTable, { inTabPanel: true, ...table, ...argsTableProps })
    };
  });
  return import_react60.default.createElement(StyledTabsView, { tabs: tabsFromEntries });
};
...
var Typeset = ({
  ...
  sampleText,
  ...props
}) => import_react61.default.createElement(Wrapper8, { ...props, className: "docblock-typeset sb-unstyled" }, fontSizes.map((size) => import_react61.default.createElement(TypeSpecimen, { key: size }, import_react61.default.createElement(Label4, null, size), import_react61.default.createElement(
  Sample,
  {
    style: {
      fontFamily,
...
function renderSwatch(color, index) {
  return import_react62.default.createElement(Swatch, { key: `${color}-${index}`, title: color, background: color });
}
function renderSwatchLabel(color, index, colorDescription) {
  return import_react62.default.createElement(SwatchLabel, { key: `${color}-${index}`, title: color }, import_react62.default.createElement("div", null, color, colorDescription && import_react62.default.createElement("span", null, colorDescription)));
}
function renderSwatchSpecimen(colors) {
  if (Array.isArray(colors))
    return import_react62.default.createElement(SwatchSpecimen, null, import_react62.default.createElement(SwatchColors, null, colors.map((color, index) => renderSwatch(color, index))), import_react62.default.createElement(SwatchLabels, null, colors.map((color, index) => renderSwatchLabel(color, index))));
  ...
  return import_react62.default.createElement(SwatchSpecimen, null, import_react62.default.createElement(SwatchColors, null, swatchElements), import_react62.default.createElement(SwatchLabels, null, labelElements));
}
var ColorItem = ({ title, subtitle, colors }) => import_react62.default.createElement(Item, null, import_react62.default.createElement(ItemDescription, null, import_react62.default.createElement(ItemTitle, null, title), import_react62.default.createElement(ItemSubtitle, null, subtitle)), import_react62.default.createElement(Swatches, null, renderSwatchSpecimen(colors)));
var ColorPalette = ({ children, ...props }) => import_react62.default.createElement(ResetWrapper, null, import_react62.default.createElement(List, { ...props, className: "docblock-colorpalette sb-unstyled" }, import_react62.default.createElement(ListHeading, null, import_react62.default.createElement(ListName, null, "Name"), import_react62.default.createElement(ListSwatches, null, "Swatches")), children));
...
var IconItem = ({ name, children }) => import_react63.default.createElement(Item2, null, import_react63.default.createElement(ItemSpecimen, null, children), import_react63.default.createElement(ItemLabel, null, name));
var IconGallery = ({ children, ...props }) => import_react63.default.createElement(ResetWrapper, null, import_react63.default.createElement(List2, { ...props, className: "docblock-icongallery sb-unstyled" }, children));
...
var Title2 = ({ headingId, title }) => typeof title == "string" || !title ? import_react64.default.createElement(
  Heading,
  {
    as: "h2",
    id: headingId,
...
) : import_react64.default.createElement("div", { id: headingId }, title);
var TableOfContents = ({
  title,
  disable,
  headingSelector,
  ...
  return import_react64.default.createElement(Aside, { className }, disable ? null : import_react64.default.createElement(Nav, { "aria-labelledby": headingId }, import_react64.default.createElement(Title2, { headingId, title }), import_react64.default.createElement("div", { className: "toc-wrapper" })));
};
var Anchor = ({ storyId, children }) => import_react65.default.createElement("div", { id: anchorBlockIdFromId(storyId), className: "sb-anchor" }, children);
function useSyncExternalStoreShim(subscribe, getSnapshot) {
  let value = getSnapshot(), [{ inst }, forceUpdate] = (0, import_react68.useState)({ inst: { value, getSnapshot } });
  return (0, import_react68.useLayoutEffect)(() => {
    inst.value = value, inst.getSnapshot = getSnapshot, didSnapshotChange(inst) && forceUpdate({ inst });
  }, [subscribe, value, getSnapshot]), (0, import_react68.useEffect)(() => (didSnapshotChange(inst) && forceUpdate({ inst }), subscribe(() => {
...
function useQuerySubscription(cacheKey, query, input, selector) {
  let cache = (0, import_react67.useRef)(void 0);
  ...
  let inputRef = (0, import_react67.useRef)(input);
  inputRef.current = input;
  let subscribe = (0, import_react67.useCallback)(
    (listener) => {
  ...
  ), getSnapshot = (0, import_react67.useCallback)(() => cache.current.state, []);
  return useSyncExternalStoreShim(subscribe, getSnapshot);
}
function useServiceDocgen(id) {
  let service = (0, import_preview_api2.getService)("core/docgen", { internal: true });
...
var useOf = (moduleExportOrType, validTypes) => (0, import_react69.useContext)(DocsContext).resolveOf(moduleExportOrType, validTypes);
...
function useResolveArgTypes(props) {
  ...
  let context = (0, import_react66.useContext)(DocsContext), resolved = useOf(of || "meta"), resolvedArgTypes;
...
function renderArgTypesTables({
  ...
  if (Object.keys(subcomponentRows).length === 0)
    return import_react66.default.createElement(ArgsTable, { rows: filteredMainRows, sort, docsLang });
  let tabs = {
  ...
  return import_react66.default.createElement(TabbedArgsTable, { tabs, sort, docsLang });
}
...
var DocgenServiceArgTypes = (props) => {
  ...
  return resolved.componentId === void 0 ? import_react66.default.createElement(ArgsTable, {
    error: "No docs found for this component on this page. Import the story file whose meta.component is this component, or pass `of={ComponentStories}`."
    /* NOT_A_STORY_COMPONENT */
  }) : import_react66.default.createElement(DocgenServiceArgTypesRows, { ...resolved, componentId: resolved.componentId });
};
var DocgenServiceArgTypesRows = ({
  argTypes,
  parameters,
  componentId,
  storyId,
  ...
  return isInitialLoading ? import_react66.default.createElement(ArgsTable, { isLoading: true }) : serviceRows ? renderArgTypesTables({
...
var ArgTypesImpl = (props) => globalThis.FEATURES?.experimentalDocgenServer ? import_react66.default.createElement(DocgenServiceArgTypes, { ...props }) : import_react66.default.createElement(LegacyArgTypes, { ...props });
...
var SourceContext = (0, import_react72.createContext)({ sources: {} });
var UNKNOWN_ARGS_HASH = "--unknown--";
var SourceContainer = ({
  children,
  channel
}) => {
  let [sources, setSources] = (0, import_react72.useState)({});
  return (0, import_react72.useEffect)(() => {
    let handleSnippetRendered = (idOrEvent, inputSource = null, inputFormat = false) => {
      ...
      setSources((current) => ({
        ...
        [id]: {
          ...current[id],
          [hash]: { code: source || "", format: format22, warning }
        }
      }));
    };
    return channel.on(SNIPPET_RENDERED, handleSnippetRendered), () => channel.off(SNIPPET_RENDERED, handleSnippetRendered);
  }, []), import_react72.default.createElement(SourceContext.Provider, { value: { sources } }, children);
};
function useServiceStory(storyId, selector) {
  let componentId = storyId.split("--")[0], service = (0, import_preview_api3.getService)("core/story-docs", { internal: true }), boundSelector = (0, import_react73.useCallback)(
...
function useTransformCode(source, transform, storyContext) {
  let [transformedCode, setTransformedCode] = (0, import_react74.useState)("Transforming..."), transformed = transform ? transform?.(source, storyContext) : source;
...
var useCode = ({
  ...
  let parameters = storyContext.parameters ?? {}, { __isArgsStory: isArgsStory } = parameters, sourceParameters = parameters.docs?.source || {}, type = typeFromProps || sourceParameters.type || SourceType.AUTO, staticSnippet = serviceSnippet || snippet, code = (
...
var useSourceProps = (props, docsContext, sourceContext, serviceSnippet = "", serviceWarning) => {
  let { of } = props, story = (0, import_react71.useMemo)(() => {
    if (of)
...
var SourceWithStoryDocsSnippet = ({ storyId, docsContext, sourceContext, ...props }) => {
  ...
  return import_react71.default.createElement(Source, { ...sourceProps });
};
var SourceWithStorySnippet = (props) => {
  let { of } = props, sourceContext = (0, import_react71.useContext)(SourceContext), docsContext = (0, import_react71.useContext)(DocsContext), story = (0, import_react71.useMemo)(() => {
    if (of)
      return docsContext.resolveOf(of, ["story"]).story;
    try {
      return docsContext.storyById();
...
var CanvasImpl = (props) => {
  ...
  return import_react70.default.createElement(
    ...
    import_react70.default.createElement(Story2, { of: of || story.moduleExport, meta: props.meta, ...props.story })
  );
};
...
var useArgsIfDefined = (story, context) => {
  let storyContext = story ? context.getStoryContext(story) : { args: {} }, { id: storyId } = story || { id: "none" }, [args, setArgs] = (0, import_react76.useState)(storyContext.args);
...
var useGlobals = (story, context) => {
  let storyContext = context.getStoryContext(story), [globals, setGlobals] = (0, import_react77.useState)(storyContext.globals);
...
var usePrimaryStory = () => {
  let context = (0, import_react78.useContext)(DocsContext), stories = context.componentStories();
...
var ControlsTables = ({
  ...
  if (Object.keys(subcomponentRows).length === 0)
    return Object.keys(filteredMainRows).length > 0 || Object.keys(args).length > 0 ? import_react75.default.createElement(
      ArgsTable,
      {
        storyId,
        controlsId,
...
var LegacyControls = ({ story, context, ...props }) => {
  ...
  return argTypes ? import_react75.default.createElement(
    ControlsTables,
    {
...
var DocgenServiceControls = ({ story, context, ...props }) => {
  ...
  return isInitialLoading ? import_react75.default.createElement(ArgsTable, { isLoading: true }) : serviceRows ? import_react75.default.createElement(
    ControlsTables,
    {
      mainName: getComponentName(component) ?? serviceRows.serviceComponentName,
      mainRows: serviceRows.mainRows,
...
var ControlsImpl = (props) => {
  let { of } = props, context = (0, import_react75.useContext)(DocsContext), primaryStory = usePrimaryStory(), story = of ? context.resolveOf(of, ["story"]).story : primaryStory;
  if (!story)
    return null;
  let storyProps = { ...props, story, context };
  return globalThis.FEATURES?.experimentalDocgenServer ? import_react75.default.createElement(DocgenServiceControls, { ...storyProps }) : import_react75.default.createElement(LegacyControls, { ...storyProps });
};
...
var AddContext = (props) => {
  let { children, ...rest } = props, parentContext = import_react81.default.useContext(DocsContext);
  return import_react81.default.createElement(DocsContext.Provider, { value: { ...parentContext, ...rest } }, children);
};
var CodeOrSourceMdx = ({
  className,
  children,
  ...
  if (typeof className != "string" && (typeof children != "string" || !children.match(/[\n\r]/g)))
    return import_react81.default.createElement(Code, null, children);
...
var AnchorInPage = ({ hash, children }) => {
  let context = (0, import_react81.useContext)(DocsContext);
  return import_react81.default.createElement(
    A2,
    {
      href: hash,
...
var AnchorMdx = (props) => {
  let { href, target, children, ...rest } = props, context = (0, import_react81.useContext)(DocsContext);
  return !href || target === "_blank" || /^https?:\/\//.test(href) ? import_react81.default.createElement(A2, { ...props }) : href.startsWith("#") ? import_react81.default.createElement(AnchorInPage, { hash: href }, children) : import_react81.default.createElement(
    A2,
    {
      href,
      onClick: (event) => {
...
var HeaderWithOcticonAnchor = ({
  ...
  let context = (0, import_react81.useContext)(DocsContext), OcticonHeader = OcticonHeaders[as], hash = `#${id}`;
  return import_react81.default.createElement(OcticonHeader, { id, ...rest }, import_react81.default.createElement(OcticonAlignmentWrapper, { className: "sb-unstyled" }, import_react81.default.createElement(OcticonAnchorWrapper, null, import_react81.default.createElement(
    Button,
    {
      asChild: true,
      variant: "ghost",
    ...
    import_react81.default.createElement(
      ...
      import_react81.default.createElement(LinkIcon, null)
    )
  )), children));
};
var HeaderMdx = (props) => {
  ...
  if (id)
    return import_react81.default.createElement(HeaderWithOcticonAnchor, { as, id, ...rest }, children);
  let Component4 = as, { as: omittedAs, ...withoutAs } = props;
  return import_react81.default.createElement(Component4, { ...nameSpaceClassNames(withoutAs, as) });
};
var HeadersMdx = SUPPORTED_MDX_HEADERS.reduce(
  (acc, headerType) => ({
    ...acc,
    // @ts-expect-error (Converted from ts-ignore)
    [headerType]: (props) => import_react81.default.createElement(HeaderMdx, { as: headerType, ...props })
  }),
  {}
);
...
var DescriptionBody = ({ resolvedOf, serviceComponentDescription, lang, storyDocsDescription }) => {
  ...
  return markdown ? import_react79.default.createElement(Markdown, { lang }, markdown) : null;
};
...
var DescriptionImpl = (props) => {
  let { of } = props, context = (0, import_react79.useContext)(DocsContext);
  if ("of" in props && of === void 0)
  ...
  if (globalThis.FEATURES?.experimentalDocgenServer) {
    if (resolvedOf.type === "story")
      return import_react79.default.createElement(DescriptionStoryWithServices, { resolvedOf });
    let componentId = resolvedOf.type === "meta" ? resolvedOf.preparedMeta.componentId : context.getComponentId(resolvedOf.component);
    if (componentId)
      return import_react79.default.createElement(DescriptionComponentWithServices, { resolvedOf, componentId });
  }
  ...
  return import_react79.default.createElement(DescriptionBody, { resolvedOf, lang });
};
...
var DocsSluggerContext = (0, import_react84.createContext)(
  null
);
...
var DocsContainer = ({
  ...
  let slugger = (0, import_react83.useMemo)(() => createDocsSlugger(), []), toc, lang;
  try {
  ...
  }), import_react83.default.createElement(DocsSluggerContext.Provider, { value: slugger }, import_react83.default.createElement(DocsContext.Provider, { value: context }, import_react83.default.createElement(SourceContainer, { channel: context.channel }, import_react83.default.createElement(ThemeProvider, { theme: ensure(theme) }, import_react83.default.createElement(
    DocsPageWrapper,
    {
      lang,
      toc: toc ? import_react83.default.createElement(
        TableOfContents,
        {
...
var HeadingImpl = ({
  ...
  if (disableAnchor || typeof children != "string")
    return import_react89.default.createElement(H2, null, children);
  let tagID = (import_react89.default.useContext(DocsSluggerContext) ?? slugs).slug(children.toLowerCase());
  return import_react89.default.createElement(HeaderMdx, { as: "h2", id: tagID, ...props }, children);
};
var Heading2 = withMdxComponentOverride("Heading", HeadingImpl);
var SubheadingImpl = ({ children, disableAnchor }) => {
  if (disableAnchor || typeof children != "string")
    return import_react88.default.createElement(H3, null, children);
  let tagID = (import_react88.default.useContext(DocsSluggerContext) ?? slugs).slug(children.toLowerCase());
  return import_react88.default.createElement(HeaderMdx, { as: "h3", id: tagID }, children);
};
...
var DocsStoryImpl = ({
  ...
  return import_react87.default.createElement(Anchor, { storyId: __primary ? `primary--${story.id}` : story.id }, expanded && import_react87.default.createElement(import_react87.default.Fragment, null, import_react87.default.createElement(Subheading, null, story.name), import_react87.default.createElement(Description2, { of })), import_react87.default.createElement(
    Canvas,
    {
      of,
      withToolbar,
...
var PrimaryImpl = () => {
  ...
  return primaryStory ? import_react86.default.createElement(DocsStory, { of: primaryStory.moduleExport, expanded: false, __primary: true, withToolbar: true }) : null;
};
...
var StoriesImpl = ({ title = "Stories", includePrimary = true }) => {
  let { componentStories, projectAnnotations, getStoryContext } = (0, import_react90.useContext)(DocsContext), stories = componentStories(), filter = projectAnnotations.parameters?.docs?.stories?.filter;
  return filter && (stories = stories.filter((story) => filter(story, getStoryContext(story)))), stories.some((story) => story.tags?.includes(import_preview_api6.Tag.AUTODOCS)) && (stories = stories.filter((story) => story.tags?.includes(import_preview_api6.Tag.AUTODOCS) && !story.usesMount)), includePrimary || (stories = stories.slice(1)), !stories || stories.length === 0 ? null : import_react90.default.createElement(import_react90.default.Fragment, null, typeof title == "string" ? import_react90.default.createElement(StyledHeading, null, title) : title, stories.map(
    (story) => story && import_react90.default.createElement(DocsStory, { key: story.id, of: story.moduleExport, expanded: true, __forceInitialArgs: true })
  ));
};
...
var SubtitleImpl = (props) => {
  ...
  return content ? import_react91.default.createElement(Subtitle, { className: "sbdocs-subtitle sb-unstyled" }, content) : null;
};
...
var TitleImpl = (props) => {
  ...
  return content ? import_react92.default.createElement(Title, { className: "sbdocs-title sb-unstyled" }, content) : null;
};
...
var DocsPage = () => {
  ...
  return import_react85.default.createElement(import_react85.default.Fragment, null, import_react85.default.createElement(Title3, null), import_react85.default.createElement(Subtitle2, null), import_react85.default.createElement(Description2, { of: "meta" }), isSingleStory ? import_react85.default.createElement(Description2, { of: "story" }) : null, import_react85.default.createElement(Primary, null), import_react85.default.createElement(Controls3, null), isSingleStory ? null : import_react85.default.createElement(Stories, null));
};
function Docs({
  context,
  docsParameter
  ...
  return import_react82.default.createElement(Container2, { context, theme: docsParameter.theme }, import_react82.default.createElement(Page, null));
}
...
function usePreview(projectAnnotations) {
  let previewRef = (0, import_react93.useRef)();
...
function ExternalDocs({
  ...
  return import_react93.default.createElement(Docs, { docsParameter, context: preview2.docsContext() });
}
var preview;
var ExternalDocsContainer = ({ projectAnnotations, children }) => ((0, import_client_logger8.deprecate)("ExternalDocsContainer is deprecated and will be removed in Storybook 11."), preview || (preview = new ExternalPreview(projectAnnotations)), import_react94.default.createElement(DocsContext.Provider, { value: preview.docsContext() }, import_react94.default.createElement(ThemeProvider, { theme: ensure(themes.light) }, children)));
var Meta = ({ of }) => {
  let context = (0, import_react95.useContext)(DocsContext);
  of && context.referenceMeta(of, true);
  try {
    let primary = context.storyById();
    return import_react95.default.createElement(Anchor, { storyId: primary.id });
  } catch {
    return null;
  }
};
var UnstyledImpl = (props) => import_react96.default.createElement("div", { ...props, className: "sb-unstyled" });
var Unstyled = withMdxComponentOverride("Unstyled", UnstyledImpl);
var WrapperImpl = ({ children }) => import_react97.default.createElement("div", { style: { fontFamily: "sans-serif" } }, children);
...
//# sourceMappingURL=chunk-7ZAGBN3C.js.map
